...
@Component(value = "dataSourceTestClient")
@FeignClient(name = "dnt-management-datasource-test", url = "${dnt.feign.test.data.source.client.url}")
public interface DataSourceTestClient {
