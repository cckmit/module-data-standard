...
@Component(value = "dataSourceDevClient")
@FeignClient(name = "dnt-management-datasource-dev", url = "${dnt.feign.dev.data.source.client.url}")
public interface DataSourceDevClient {

    @GetMapping(value = {"/data/source/getDefaultDataSource"})
    JSONObject getDefaultDataSource(@RequestHeader("modelType")String modelType,
